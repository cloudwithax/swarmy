...
func init() {
	...
	os.Unsetenv("SWARMY_GLOBAL_CONFIG")
	os.Unsetenv("SWARMY_GLOBAL_DATA")
}
...
func TestDirs(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakeconfig/swarmy") + "\n" +
		filepath.FromSlash("/tmp/fakedata/swarmy") + "\n"
...
func TestDataDir(t *testing.T) {
	...
	expected := filepath.FromSlash("/tmp/fakedata/swarmy") + "\n"
	require.Equal(t, expected, b.String())
}
