...
swarmy update-providers

# Update Catwalk providers from a custom URL
swarmy update-providers https://example.com/providers.json

# Update Catwalk providers from a local file
swarmy update-providers /path/to/local-providers.json

# Update Catwalk providers from embedded version
swarmy update-providers embedded

# Update Hyper provider information
swarmy update-providers --source=hyper

# Update Hyper from a custom URL
swarmy update-providers --source=hyper https://hyper.example.com
`,
